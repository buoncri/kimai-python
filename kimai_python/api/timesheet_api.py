...
class TimesheetApi(object):
    ...
    def api_timesheets_get(self, **kwargs):  # noqa: E501
        ...
        :param str tags: Comma separated list of tag names
        ...
        :param str billable: Filter for non-/billable records. Allowed values: 0=non-billable, 1=billable (default: all)
    ...
    def api_timesheets_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['user', 'customer', 'customers', 'project', 'projects', 'activity', 'activities', 'page', 'size', 'tags', 'order_by', 'order', 'begin', 'end', 'exported', 'active', 'billable', 'full', 'term', 'modified_after']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'billable' in params:
            query_params.append(('billable', params['billable']))  # noqa: E501
        if 'full' in params:
    ...
    def api_timesheets_post(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param TimesheetEditForm body: (required)
        :param str full: Allows to fetch fully serialized objects including subresources (TimesheetEntityExpanded). Allowed values: true (default: false)
        :return: TimesheetEntity
                 If the method is called asynchronously,
                 returns the request thread.
        """
