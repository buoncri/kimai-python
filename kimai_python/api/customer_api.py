...
class CustomerApi(object):
    ...
    def api_customers_id_rates_post(self, body, id, **kwargs):  # noqa: E501
        """Adds a new rate to a customer  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_customers_id_rates_post(body, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_customers_id_rates_post_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_customers_id_rates_post_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def api_customers_id_rates_post_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Adds a new rate to a customer  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_customers_id_rates_post_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
