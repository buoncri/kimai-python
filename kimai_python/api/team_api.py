...
class TeamApi(object):
    ...
    def api_teams_id_activities_activity_id_delete(self, id, activity_id, **kwargs):  # noqa: E501
        """Revokes access for an activity from a team  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_teams_id_activities_activity_id_delete(id, activity_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_teams_id_activities_activity_id_delete_with_http_info(id, activity_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_teams_id_activities_activity_id_delete_with_http_info(id, activity_id, **kwargs)  # noqa: E501
            return data

    def api_teams_id_activities_activity_id_delete_with_http_info(self, id, activity_id, **kwargs):  # noqa: E501
        """Revokes access for an activity from a team  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_teams_id_activities_activity_id_delete_with_http_info(id, activity_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_teams_id_activities_activity_id_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_teams_id_activities_activity_id_delete`")  # noqa: E501
        # verify the required parameter 'activity_id' is set
        if ('activity_id' not in params or
                params['activity_id'] is None):
            raise ValueError("Missing the required parameter `activity_id` when calling `api_teams_id_activities_activity_id_delete`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/teams/{id}/activities/{activityId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_teams_id_activities_activity_id_post(self, id, activity_id, **kwargs):  # noqa: E501
        """Grant the team access to an activity  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_teams_id_activities_activity_id_post(id, activity_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_teams_id_activities_activity_id_post_with_http_info(id, activity_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_teams_id_activities_activity_id_post_with_http_info(id, activity_id, **kwargs)  # noqa: E501
            return data

    def api_teams_id_activities_activity_id_post_with_http_info(self, id, activity_id, **kwargs):  # noqa: E501
        """Grant the team access to an activity  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_teams_id_activities_activity_id_post_with_http_info(id, activity_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_teams_id_activities_activity_id_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_teams_id_activities_activity_id_post`")  # noqa: E501
        # verify the required parameter 'activity_id' is set
        if ('activity_id' not in params or
                params['activity_id'] is None):
            raise ValueError("Missing the required parameter `activity_id` when calling `api_teams_id_activities_activity_id_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/teams/{id}/activities/{activityId}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_teams_id_patch(self, body, id, **kwargs):  # noqa: E501
        ...
        Update an existing team, you can pass all or just a subset of all attributes (passing members will replace all existing ones)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
