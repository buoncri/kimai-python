...
[**api_plugins_get**](DefaultApi.md#api_plugins_get) | **GET** /api/plugins | Returns information about installed Plugins
...
try:
    # Returns information about installed Plugins
    api_response = api_instance.api_plugins_get()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->api_plugins_get: %s\n" % e)
```
